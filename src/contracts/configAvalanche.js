// ============================================================
// AVALANCHE C-CHAIN MAINNET - configAvalanche.js
// Chain ID: 43114 | Explorer: snowtrace.io
// ============================================================

import TokenContractAbi from "./TokenContractAbi.json";
import PresaleContractAbi from "./PresaleContractAbi.json";

export const networkLink = "https://snowtrace.io/tx/";

// ⚠️ ATUALIZE estes endereços após o deploy na Avalanche mainnet ⚠️
...
// Taxa de câmbio AVAX/USD
export const GetUSDExchangeRate = async () => {
  const requestOptions = { method: "GET", redirect: "follow" };
  return fetch(
    "https://api.coinbase.com/v2/exchange-rates?currency=AVAX",
    requestOptions
  )
    .then((response) => response.json())
    .then((result) => result.data.rates.USD)
    .catch((error) => {
      console.error("AVAX/USD rate error:", error);
      return "0";
    });
};
